        ...
        private ValueRange CreateValueRange(Organizationshopproductsdata productData)
        {
            ...
            return new ValueRange
            {
                Values = ItemsMapper.MapToRangeData(new FaceBookItems
                {
                    ...
                    Google_product_category = $"{productData.Categoryname.Replace(' ', '-')}>{productData.Brandname}",
                    Fb_product_category = $"{productData.Categoryname.Replace(' ', '-')}>{productData.Brandname}",
