...
public partial class SystemPropertyHouseAgreementAgentModalPage : ContentPage
{
    public SystemPropertyHouseAgreementAgentModalPage(PropertyHouseAgentViewModel viewModel)
    {
        InitializeComponent();
    ...
    private async void Button_Save_Signature_Clicked(object sender, EventArgs e)
    {
        ...
        await ((PropertyHouseAgentViewModel)BindingContext).AgreeToPropertyHouseAgreementasync(imageUrl);
    }
