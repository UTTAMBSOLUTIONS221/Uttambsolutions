...
public partial class PropertyCaretakerDashboardPage : ContentPage
{
    public PropertyCaretakerDashboardPage(SummaryDashBoardViewModel viewModel)
    {
        InitializeComponent();
    ...
    private async void OnWhatsAppButtonClicked(object sender, EventArgs e)
    {
        ...
        var message = $"{greeting} {fullName}, welcome to Maqao plus from caretaker department. Your number one property management system. We are here to help";
