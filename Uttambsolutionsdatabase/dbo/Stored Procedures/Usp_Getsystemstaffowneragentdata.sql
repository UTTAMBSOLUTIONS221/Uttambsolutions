CREATE PROCEDURE [dbo].[Usp_Getsystemstaffowneragentdata]
AS
BEGIN
   BEGIN
	DECLARE 
		...
		INNER JOIN Systemstaffdesignations DESG ON Systemstaff.Userid=DESG.Systemstaffid
		WHERE DESG.Staffdesignation!='Tenant' AND Systemstaff.Isactive=1 AND Systemstaff.Isdeleted=0
