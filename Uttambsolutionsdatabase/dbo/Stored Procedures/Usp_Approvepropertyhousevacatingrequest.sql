...
BEGIN
    ...
    BEGIN TRY
		...
		UPDATE Systempropertyhouseroomstenant SET  Occupationalstatus = 0,Isoccupant= 0 WHERE Systempropertyhousetenantid= JSON_VALUE(@JsonObjectdata, '$.Systempropertyhousetenantid') AND Systempropertyhouseroomid= JSON_VALUE(@JsonObjectdata, '$.Systempropertyhouseroomid');
