CREATE PROCEDURE [dbo].[Usp_Getallsystempropertyhouseroomtenantsdata]
   ...
   BEGIN
	DECLARE 
		...
		SET @Systempropertyhouseroomtenantsdata= 
			  ...
			  WHERE Systemstaffdesignation.Staffdesignation='Tenant' AND Systemtenant.Occupationalstatus IN(0,1,2)
		      FOR JSON PATH
			) AS Data
